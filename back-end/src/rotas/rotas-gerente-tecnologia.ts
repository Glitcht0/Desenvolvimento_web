...
RotasGerenteTecnologia.delete("/participacao-mineracao/:id", verificarToken, verificarPerfilGerenteTecnologia, ServiçosGerenteTecnologia.removerParticipaçãoMineração);
